...
class _PendudukScreenState extends State<PendudukScreen> with AutomaticKeepAliveClientMixin {
  ...
  late Map<int, List<PieChartSectionData>> _cachedPieDataByYear;
  late Map<int, Map<String, dynamic>> _ageDataByYear;
  late final List<Color> _districtColors;
            ...
            child: LineChart(
              LineChartData(
                ...
                borderData: FlBorderData(
                  show: true,
                  border: Border(
                    left: BorderSide(color: const Color(0xFFE9ECEF), width: 1),
              ...
              child: SizedBox(
                ...
                child: PieChart(
                  PieChartData(
                    ...
                    sections: _cachedPieDataByYear[selectedYear] ?? [],
                  ),
                ),
              ),
            ),
            ...
            if (districts.isNotEmpty) ...[
              ...
              Container(
                ...
                child: Center(
                  child: Column(
                    children: [
                      Icon(Icons.info_outline, size: 48, color: const Color(0xFFADB5BD)),
                      const SizedBox(height: 8),
                      Text(
